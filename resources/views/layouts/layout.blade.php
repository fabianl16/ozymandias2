        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="/"><i class="menu-icon fa fa-history"></i>Refrescar</a>
                    </li>
                    <li class="menu-title">Monitoreo</li><!-- /.menu-title -->

                    <li class="menu-title">Datos</li><!-- /.menu-title -->
                    <li>
            ...
            <div class="top-right">
                <div class="header-menu">
                    <div class="user-area dropdown float-right">
                        <a class="navbar-brand" href="https://www.uabcs.mx/inicio" aria-haspopup="true" aria-expanded="false">
...
<script type="text/javascript">
        ...
        $('#calculating-button').click(function(e){
      ...
      alert("El campo está vacio y es OBLIGATORIO");
      return false;
    }else{
       var div= document.getElementById('idRegistrar');
       div.style.visibility='visible';

 var sal = {{$testMonitorItem->salinidad}};
var temp = {{$testMonitorItem->temperature}};
var ph = {{$testMonitorItem->ph}};
...
var amoniacoIonizado= tan-TotalAmoniaco;
        document.getElementById("amoniacoNH3").innerHTML = TotalAmoniaco;
        document.getElementById("amoniacoIonizadoId").innerHTML = amoniacoIonizado;
        ...
        headers: {
            ...
            $('#registrar-button').click(function(e){
...
var amoniacoIonizado= tan-TotalAmoniaco;
        ...
        $.ajax({
           ...
           data:{temperature:temp, salinidad:sal, ph:ph, tan:tan, amoniacoNoIonizado:TotalAmoniaco,
            amoniacoIonizado:amoniacoIonizado},
